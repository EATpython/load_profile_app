...
def plot_load_profile(load_df, meta_df):
    ...
    if y_axis_units == 'Annual Operating Hours':
        ...
        y2_title_text = "<b>Cumulative Annual Operating Hours</b><br>(100% = {:,}".format(int(sum(counts) * td_in_hrs)) + " hours)"
        ...
        customdata = np.stack([decimal_labels, increment_labels]).transpose()
        y1_title_text = "<b>Annual Therms within Percent Load Bin</b>"
        y2_title_text = "<b>Cumulative Annual Percent Therm Consumption</b><br>(100% = {:,}".format(round(total_load)) + " kBtus)"
    ...
    fig.update_xaxes(
        ...
        title_text='<b>Percent of Design Load</b>',
        showline=True,
        linewidth=2,
        linecolor='black',
        mirror=True,
